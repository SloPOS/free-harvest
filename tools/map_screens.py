...
KNOWN = {
    ...
    8:  "Pre-defrost / pump purge  (300 s countdown; buttons unmapped)",
    9:  "Defrosting  (from the dryer's screen list; never captured)",
    10: "Defrost complete  (from the dryer's screen list; never captured)",
    15: "Diagnostics",
    ...
    44: "Final dry, the single frame at the handover to the timed stage (= 6)",
}
...
#
# Screen 44 is the final-dry screen itself: one frame in the type-6 layout at
# the handover from drying-to-completion to the timed final dry, then type 6
# again. Screens 9 and 10 (defrosting, defrost complete) are still WANTED - the
# adapter names them but nobody has captured either frame.
